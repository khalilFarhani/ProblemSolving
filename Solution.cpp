...
//Return the kth smallest fraction considered.Return your answer as an array of integers of size 2, where answer[0] == arr[i] and answer[1] == arr[j].
   ...
   // problem 153 : Given a string indicating a range of letters, return a string which includes all the letters in that range, including the last letter.
   ...
   // problem 154 : Given an array of integers nums, sort the array in increasing order based on the frequency of the values. If multiple values have the same frequency, sort them in decreasing order.
   ...
   // problem 156 : Consider the word "abode". We can see that the letter a is in position 1 and b is in position 2. In the alphabet, a and b are also in positions 1 and 2. Notice also that d and e in abode occupy the positions they would occupy in the alphabet, which are positions 4 and 5.
   ...
   //problem 169 : leetcode 3423. Maximum Difference Between Adjacent Elements in a Circular Array
   ...
   //problem 170 : leetcode 3174. Clear Digits
   string clearDigits(string s) {
       stack<int>st;
       string ans = "";
       for (int i = 0;i < s.size();i++) {
           if (s[i] < 58 && s[i]>47) { //number (0---9)
               if (!st.empty())
                   st.pop();
           }
           else
